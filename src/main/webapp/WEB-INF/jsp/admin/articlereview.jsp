        ...
        <article class="cl pd-20">
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody>
                    <c:forEach items="${adminArticleReivewVos}" var="adminArticleReivewVos">
                    <tr class="text-c">
                        <td>${adminArticleReivewVos.reviewId}</td>
                        <td><a style="cursor:pointer" href="admin/articlereviewdetail.action?reviewId=${adminArticleReivewVos.reviewId}">${adminArticleReivewVos.username}</a></td>
                        <td>${adminArticleReivewVos.articleTitle}</td>
                        <td>
                            <fmt:formatDate value="${adminArticleReivewVos.reviewDate}" pattern="yyyy-MM-dd" type="date"/>
                            <%--<fmt:formatDate value=" ${articles.articleDate}" pattern="yyyy-MM-dd" type="date"/>--%>
                        </td>
                        <td>${adminArticleReivewVos.reviewContent}</td>
                        <td>${adminArticleReivewVos.reviewZan}</td>
...
<script>
    ...
    function article_del(obj, id) {
        ...
        layer.confirm('确认要删除吗？', function(index) {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/admin/ajaxdeletearticlereview.action',
