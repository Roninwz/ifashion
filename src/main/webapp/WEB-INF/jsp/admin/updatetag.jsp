...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <form class="form form-horizontal" id="form-article-add" enctype='multipart/form-data' action="admin/updatehandletag.action" method="post">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${tag.tagName}" placeholder=""  name="tagName">
                    </div>
                </div>
