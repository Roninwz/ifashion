                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="product-page-cart">
                            ...
                            <button class="btn btn-primary" onclick="maiss()">立即购买</button>
                            <script>
                             function maiss() {
                                  /*  alert("11111");*/
                                 ...
                                 window.location.href="${pageContext.request.contextPath}/user/receive_address.action?goodsNum="+num+"&price="+'${goods.goodsPrice}'+"&goodsId="+'${goods.goodsId}&desId='+${map1[goods].userId}
