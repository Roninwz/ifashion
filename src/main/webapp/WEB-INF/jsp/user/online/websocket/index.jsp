...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="" style="width: 60%;float:left;">
            <!-- 聊天区 -->
            <div class="am-scrollable-vertical" id="chat-view" style="height: 410px;">
                <ul class="am-comments-list am-comments-list-flip" id="chat">
                    <c:set var="user" value="${sessionScope.user}"/>
                    <c:set var="userImg" value="${user.userImgurl}"/>
                </ul>
            </div>
            <!-- 输入区 -->
            ...
            <!-- 按钮区 -->
            <div class="am-btn-group am-btn-group-xs" style="float:right;height:100px;">
...
<script>
    ...
    var wsServer = null;
    var ws = null;
    wsServer = "ws://" + location.host+"${pageContext.request.contextPath}" + "/chatServer.action";
    ...
    function showChat(message){
       ...
       alert('${pageContext.request.contextPath }/${userImg}')


       /* alert("/"+message.from+"/userImgurl")*/

    /*   <img width="48" height="48" class="am-comment-avatar" alt="" src='<%--${pageContext.request.contextPath }/${userImg}--%>'>*/

        var html = "<li class=\"am-comment "+isSef+" am-comment-primary\"><a href=\"#link-to-user-home\"><img width=\"48\" height=\"48\" class=\"am-comment-avatar\" alt=\"\" src='${pageContext.request.contextPath }/${userImg}'></a><div class=\"am-comment-main\">\n" +
