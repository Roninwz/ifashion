...
<div class="container">
    ...
    <div class="crumbs">
        ...
        <a href="${pageContext.request.contextPath }/user/newsHome.action" title="时装潮流" target="_blank">社区</a> &gt;
        ...
        <div class="left-container">
            ...
            <div class="article-wrap">
                ...
                <div class="article-content clearfix">
                    ${article.content}
                    <p class="statement">©版权声明：本文为iFashion独家原创，如需转载请注明出处。</p>
                </div>
                ...
                <div class="pager-tip clearfix">
                    <div class="left-pager">
                        ...
                        <c:if test="${not empty preArticle.articleId}">
                            <a href="${pageContext.request.contextPath }/user/newsInfo.action?articleId=${preArticle.articleId}" title="">
                    ...
                    <div class="right-pager">
                        ...
                        <c:if test="${not empty nextArticle.articleId}">
                            <a href="${pageContext.request.contextPath }/user/newsInfo.action?articleId=${nextArticle.articleId}" title="">
