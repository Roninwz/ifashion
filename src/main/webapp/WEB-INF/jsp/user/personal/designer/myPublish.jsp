...
<head>
    ...
    <script  src="static/user/designer/js/index.js"></script>
    <%--导航栏js--%>
        ...
        <div class="grid_wrapper">
            <div class="wrap">
                ...
                <div id="content">
                    ...
                    <div class="con clearfix" id="one" style="display: block;">
                        <c:forEach var="article" items="${article}">
                            <div class="exp-lf noMleft">
                                ...
                                <a href="" title="${article.articleTitle}" target="_blank">
                                    <img src="${article.imgurl}" alt="${article.articleTitle}" width="250" height="300"/>
                                    <span class="img-txt">${article.articleTitle}</span>
                                </a>
                            </div>
                        </c:forEach>
                    ...
                    <div class="con clearfix" id="one" style="display: none;">
                        <c:forEach var="topics" items="${topics}" >
                            <div class="exp-lf noMleft">
                                <a href="" title="${topics.topicTitle}" target="_blank">
                                    <%--static/user/article/news/image/5afe33a839da5_804.jpg--%>
                                    <img src="${topics.topicImgurl}" alt="${topics.topicContent}" width="250" height="300">
                                    <span class="img-txt">${topics.topicTitle}</span>
                                </a>
                            </div>
                        </c:forEach>
                        <div class="exp-center">
                            <a href="" title="“源自运动，融和时尚”-JOMA发布2018秋冬新品" target="_blank">
                                <img src="static/user/article/news/image/5b02961787f1d_342.jpg" alt="" width="250" height="300">
                                <span class="img-txt">“源自运动，融和时尚”-JOMA发布2018秋冬新品</span>
                            </a>
                        </div>
                    </div>
