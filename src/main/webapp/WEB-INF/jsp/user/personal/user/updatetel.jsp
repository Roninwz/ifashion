    ...
    <div class="col-main">
        ...
        <div class="main-wrap">
            <div class="user-info">
                ...
                <!--个人信息 -->
                <div class="info-main">
                    <form class="am-form am-form-horizontal" action="user/updatetelcheck.action" method="post">
                        ...
                        <div class="am-form-group">
                            <label for="user-name2" class="am-form-label">原手机号</label>
                            <div class="am-form-content">
                                <input type="text" name="beforTel" id="user-name1" placeholder="请输入旧手机号">

                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="user-name2" class="am-form-label">新手机号</label>
                            <div class="am-form-content">
                                <input type="text" name="tel" id="user-name2" placeholder="请输入新手机号">
