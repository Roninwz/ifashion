    ...
    <div class="col-main">
        ...
        <div class="main-wrap">
            <div class="user-info">
                ...
                <!--个人信息 -->
                <div class="info-main">
                    <form class="am-form am-form-horizontal" action="user/updatepasswordcheck.action" method="post">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input type="password" name="beforePass" id="user-name1" placeholder="请输入原密码">

                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="user-name2" class="am-form-label">新密码</label>
                            <div class="am-form-content">
                                <input type="password" name="password" id="user-name2" placeholder="请输入新密码">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input type="password" name="surePass" id="user-name3" placeholder="请输入确认密码">

                            </div>
                        </div>

                        <div class="info-btn">
                            <div style="width: 100px;margin-left:70px;top:30px;"><input type="submit" name="submit" value="保存修改"></div>
                        </div>
