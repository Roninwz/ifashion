    ...
    <div class="col-main">
        ...
        <div class="main-wrap">
            ...
            <div class="user-address">
                ...
                <div class="clear"></div>
                <a class="new-abtn-type" data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0}">新增地址</a>
                <!--例子-->
                <div class="am-modal am-modal-no-btn" id="doc-modal-1">
                    ...
                    <div class="add-dress">
                        ...
                        <div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
                            <form class="am-form am-form-horizontal" action="user/addhandleaddress.action" method="post">

                                <div class="am-form-group">
                                    <label for="user-name" class="am-form-label">收货人</label>
                                    <div class="am-form-content">
                                        <input type="text" name="receiverName" id="user-name" placeholder="收货人">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-content">
                                        <textarea class="" rows="3" name="addressContent" id="user-intro" placeholder="输入详细地址"></textarea>
