...
function loadFlow(count){
  ...
  for(var i=1;i<=count;i++){
    ...
    if(i==1){
      ...
      flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:37%'>选种类"+"</strong>\n";
      flowVar += "</div>\n";
    }/*else{
      ...
      if(i==2){
          flowVar += "<div class='flowList for-cur"+flowFor +"' style='position:relative'>\n";
          flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:37%'>选类型"+"</strong>\n";
          flowVar += "</div>\n";
      }
      if(i==3){
          flowVar += "<div class='flowList for-cur"+flowFor +"' style='position:relative'>\n";
          flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:37%'>选材质"+"</strong>\n";
          flowVar += "</div>\n";
      }
      if(i==4){
          flowVar += "<div class='flowList for-cur"+flowFor +"' style='position:relative'>\n";
          flowVar += "	<em style='position:absolute;left:35%'>"+i+"</em><br/><strong style='position:absolute;left:37%'>选风格"+"</strong>\n";
          flowVar += "</div>\n";
      }
