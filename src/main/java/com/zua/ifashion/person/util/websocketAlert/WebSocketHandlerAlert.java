...
public class WebSocketHandlerAlert extends TextWebSocketHandler {

    @Autowired
    private MyMessageService myMessageService;

    private static final ArrayList<WebSocketSession> users;//这个会出现性能问题，最好用Map来存储，key用userid
    private static Logger logger = Logger.getLogger(WebSocketHandlerAlert.class);
    static {
        users = new ArrayList<WebSocketSession>();
    }

    public WebSocketHandlerAlert() {
